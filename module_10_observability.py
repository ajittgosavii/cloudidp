...
class ObservabilityIntegrationModule:
    ...
    def render(self):
        ...
        st.markdown("## Observabilityintegration")
        ...
        with tabs[1]:
            self.render_logging_stack()
        
        with tabs[2]:
            self.render_metrics_collection()
        
        with tabs[3]:
            self.render_change_tracking()
        
        with tabs[4]:
            self.render_policy_violations()
        
        with tabs[5]:
            self.render_event_alerting()
