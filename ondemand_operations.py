...
class OnDemandOperationsModule:
    ...
    def render(self):
        ...
        st.markdown("## Ondemandoperations")        
        # Mode indicator
        ...
        with tabs[0]:
            self.render_ondemand_overview()
        
        with tabs[1]:
            self.render_provisioning_api()
        
        with tabs[2]:
            self.render_guardrail_validation()
        
        with tabs[3]:
            self.render_deployment_templates()
        
        with tabs[4]:
            self.render_rightsizing()
        
        with tabs[5]:
            self.render_storage_tiering()
        
        with tabs[6]:
            self.render_autoscaling()
